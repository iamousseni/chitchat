...
<head>
    ...
    <link rel="stylesheet" href="css/style.css?cod=<?php echo filemtime('css/style.css'); ?>">
    <!-- font awesome -->
...
<script src="js/recoveryUserData.js?c=<?php echo filemtime('js/recoveryUserData.js') ?>"></script>
</body>
</html>